...
## Weapon Enchantments (30)

| Enchantment | Description | Max Level | Primary Items | Secondary Items | Incompatible With | Weight |
|---|---|---:|---|---|---|---:|
| Attack Reach | Increases Attack Reach | 4 | Melee Weapons (swords, spears) | Weapons (swords, spears, axes, maces) | — | 4 |
...
| Death Bringer | Low-health hits can smash enemies back with deathly force | 3 | Melee Weapons (swords, spears) | Weapons (swords, spears, axes, maces) | — | 2 |
...
| Ice Aspect | Freezes the target | 3 | Melee Weapons (swords, spears) | Weapons (swords, spears, axes, maces) | — | 5 |
...
| Vampire | Heals you on attack | 3 | Melee Weapons (swords, spears) | Weapons (swords, spears, axes, maces) | — | 2 |
| Venom | Applies Poison to the target | 2 | Melee Weapons (swords, spears) | Weapons (swords, spears, axes, maces) | — | 5 |
| Villager Defense | Increased Damage to Illager Mobs | 5 | Melee Weapons (swords, spears) | Weapons (swords, spears, axes, maces) | Sharpness<br>Smite<br>Bane of Netherspawn | 10 |
| Wisdom | Produces more XP from mob kills | 5 | Melee Weapons (swords, spears) | Weapons (swords, spears, axes, maces) | — | 5 |
| Wither | Applies Wither to the target | 2 | Melee Weapons (swords, spears) | Weapons (swords, spears, axes, maces) | — | 5 |

---

## Tool Enchantments (10)
...
| Prospector | Chance to get extra experience when mining valuable ores | 3 | Mining Tools (axes, pickaxes, shovels, hoes, shears) | Mining Tools (axes, pickaxes, shovels, hoes, shears) | — | 5 |
...
## Armor Enchantments (32)

| Enchantment | Description | Max Level | Primary Items | Secondary Items | Incompatible With | Weight |
|---|---|---:|---|---|---|---:|
| Aerial Grace | Softens falls and lets you glide after taking damage | 3 | Boots | Boots | — | 5 |
| Cold Steel | Applies Mining Fatigue to the attacker | 3 | Chest Armor | Chest Armor | — | 4 |
| Curse Of Embers | Taking damage can ignite you and scorch nearby enemies | 3 | Equippables (armor, elytra, skulls, carved pumpkin) | Equippables (armor, elytra, skulls, carved pumpkin) | — | 1 |
| Curse Of Lead | A curse that makes your boots heavy but harder to knock around | 2 | Boots | Boots | — | 1 |
| Darkness Cloak | Applies Darkness to the attacker | 3 | Chest Armor | Chest Armor | — | 4 |
| Dragon Heart | Increases Health | 5 | — | Chest Armor | — | — |
| Elemental Protection | Reduces Elemnetal Damage | 4 | All Armor | All Armor | — | 4 |
| Featherweight | Makes your boots lighter, improving jump strength, movement speed, and safe falling | 3 | Boots | Boots | — | 4 |
| Fire Shield | Ignites the attacker | 4 | Chest Armor | Chest Armor | — | 4 |
| Flame Walker | Allows the wearer to walk on lava, and immunity to magma damage | 1 | — | Boots | Frost Walker<br>Water Walker | — |
| Grow | Makes the wearer a bit bigger | 5 | Helmets | Helmets | Shrink | 4 |
| Hardened | Provides Resistance when damaged | 3 | Chest Armor | Chest Armor | — | 4 |
| Ice Shield | Applies Slowness to the attacker | 3 | Chest Armor | Chest Armor | — | 4 |
| Iron Will | Increases knockback resistance and max health while wearing chest armor | 3 | Chest Armor | Chest Armor | — | 3 |
| Jumping | Increases Jump Height | 3 | Boots | Boots | — | 4 |
| Kamikadze | Creates an explosion on death | 5 | Chest Armor | Chest Armor | — | 4 |
| Lightweight | Chance to not trample farmland and turtle eggs | 3 | Boots | Boots | — | 4 |
| Night Vision | Provides the wearer with Permanent Night Vision | 1 | Helmets | Helmets | — | 5 |
| Obsidian Shield | Provides permanent Fire Resistance | 1 | Helmets | Helmets | — | 3 |
| Path Speed | Increases speed on dirt path blocks | 3 | Boots | Boots | — | 5 |
| Phoenix Guard | Bursts into healing flame when low on health | 3 | Chest Armor | Chest Armor | — | 3 |
| Rebound | Allows you to crouch and Bounce when falling to avoid fall damage | 1 | — | Boots | — | — |
| Regrowth | Randomly Heals the Wearer | 5 | Chest Armor | Chest Armor | — | 3 |
| Rocket Escape | Blast off into the air at low health | 3 | Boots | Boots | — | 3 |
| Saturation | Random Chance to feed you | 5 | Helmets | Helmets | — | 3 |
| Shrink | Makes the wearer a bit smaller | 5 | Helmets | Helmets | Grow | 4 |
| Speed | Increases Speed | 3 | Boots | Boots | — | 4 |
| Static Field | Builds up static and shocks attackers | 3 | Leggings | Leggings | — | 4 |
| Stopping Force | Incrases Knockback Resistance | 3 | Leggings | Leggings | — | 4 |
| Traveller | Increases Step Height | 2 | Boots | Boots | — | 4 |
| Water Breathing | Provides the wearer with Water Breathing | 1 | Helmets | Helmets | — | 5 |
| Water Walker | Allows the wearer to walk on water | 1 | — | Boots | Frost Walker<br>Flame Walker | — |
...
## Fishing Rod Enchantments (5)

| Enchantment | Description | Max Level | Primary Items | Secondary Items | Incompatible With | Weight |
|---|---|---:|---|---|---|---:|
| Angler's Arm | Increases fishing rod reach and can yank hooked creatures harder | 3 | Fishing Rods | Fishing Rods | — | 4 |
...
## Universal Enchantments (3)

| Enchantment | Description | Max Level | Primary Items | Secondary Items | Incompatible With | Weight |
|---|---|---:|---|---|---|---:|
| Curse of Breaking | When you use your item, it will do additional durability damage | 3 | Universal Pack Items (weapons, mining tools, equippables, tridents) | Universal Pack Items (weapons, mining tools, equippables, tridents) | — | 1 |
| Curse Of Fumbling | Sometimes your item slips and your action fails | 3 | Durability Items (armor, elytra, shield, tools, weapons, bows, tridents, fishing rod, etc.) | Durability Items (armor, elytra, shield, tools, weapons, bows, tridents, fishing rod, etc.) | — | 1 |
| Restore | Has a chance to save your item from breaking | 3 | Universal Pack Items (weapons, mining tools, equippables, tridents) | Universal Pack Items (weapons, mining tools, equippables, tridents) | — | 1 |
